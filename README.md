...
Temperature and humidity values are receiving from <a href="https://github.com/beyondbest/IoTEggBLE-Device" target="_blank">IoTEgg Device </a> via BLE. And it can change the RGB LED color by transmitting LED value to IoTEgg Device via BLE.
